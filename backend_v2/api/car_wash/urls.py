...
from api.car_wash.views import CarWashViewSet, CarViewSet, BoxViewSet, CarTypeViewSet, CarWashEarningsViewSet
from api.manager.views import ManagerViewSet, WasherViewSet, WasherEarningsViewSet
...
router.register(fr'car-wash/(?P<car_wash_id>{UUID_REGEX})/car-type', CarTypeViewSet, basename='car-wash-car-types')
