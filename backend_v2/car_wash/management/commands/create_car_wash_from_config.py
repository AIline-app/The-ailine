...
DEFAULT_DATA = {
    ...
    "car_wash": {
        ...
        "documents": {
            "iin": "240540019284",
            "legal_address": "Республика Казахстан, город Алматы, Алмалинский район, улица Толе Би, дом 185, почтовый индекс 050012",
            "legal_name": "Товарищество с ограниченной ответственностью \"Жалпасбаев И.Т.\"",
        }
    },
    "users": {
